...
class AssetPreloadTest < Minitest::Test
  ...
  def test_reports_stylesheet_preloading
    ...
    assert_offenses(<<~END, offenses)
      For better performance, prefer using the preload argument of the stylesheet_tag filter at app/views/pages/index.liquid:1
    END
  end
  ...
  def test_reports_image_preloading
    ...
    assert_offenses(<<~END, offenses)
      For better performance, prefer using the preload argument of the image_tag filter at app/views/pages/index.liquid:1
    END
  end
  ...
  def test_reports_general_preloading
    ...
    assert_offenses(<<~END, offenses)
      For better performance, prefer using the preload_tag filter at app/views/pages/index.liquid:1
    END
  end
end
