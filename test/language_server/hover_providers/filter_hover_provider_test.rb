  ...
  module LanguageServer
    class FilterHoverProviderTest < Minitest::Test
      ...
      def test_hovers_asset_url
        ...
        assert_can_hover_with(@provider, "{{ 'foo.js' | asset_url", result)
      end
      ...
      def test_hovers_l_filter_which_is_an_alias
        ...
        assert_can_hover_with(@provider, "{{ 'now' | to_time | l", result)
      end
      ...
      def test_hovers_array_group_by
        ...
        assert_can_hover_with(@provider, "{{ foo | array_group_by", result)
      end
      ...
      def test_hovers_hash_merge
        ...
        assert_can_hover_with(@provider, "{{ obj | hash_merge", result)
      end
      ...
      def test_hover_in_assign_tag
        ...
        assert_can_hover_with(@provider, "{% assign url = url | append: '#' | append", result)
      end
      ...
      def test_hover_in_parse_json
        ...
        assert_can_hover_with(@provider, "{% assign json = '{}' | parse_json", result)
      end
      ...
      def test_hover_in_default
        ...
        assert_can_hover_with(@provider, "{% assign json = '{}' | default", result)
      end
    end
  end
end
