  ...
  module LanguageServer
    class GraphqlPartialCompletionProviderTest < Minitest::Test
      ...
      def test_suggests_existing_graphql_files
        ...
        assert_can_complete_with(@provider, markup, "hello/my_html", -17)
        refute_can_complete_with(@provider, markup, "modules/my-module/hello/my_html", -17)
        refute_can_complete_with(@provider, markup, "hello/my-lib", -17)
        refute_can_complete_with(@provider, markup, "hello/my-html-partial", -17)

        markup = '{% graphql res = "modules/", arg: 10 %}'

        refute_can_complete_with(@provider, markup, "hello/my-function", -17)
        refute_can_complete_with(@provider, markup, "hello/my_html", -17)
      ...
      def test_not_suggests_existing_graphql_files_for_argument
        ...
        refute_can_complete_with(@provider, markup, "hello/my-function", -7)
        refute_can_complete_with(@provider, markup, "hello/my_html", -7)
        refute_can_complete_with(@provider, markup, "modules/my-module/hello/my_html", -7)
